<?php
	...
	if(isset($_SESSION["user"]) && $_SESSION["user"]->__get("loggedIn"))
	{
		...
		$sql = "SELECT bestelling.bestelnummer as bestelnr, bestelling.besteldatum as datum, bestelling.idproject as projectid,
 			bestelling.rnummer as rnummer, bestellingproduct.idproduct as productid, bestellingproduct.leverancier as leverancier,
 			bestellingproduct.aantal as aantal, bestellingproduct.prijs as prijs
